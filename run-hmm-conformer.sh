...
if [ $stage -le 27 ]; then
  local/chain/decode.sh --datadir data/dev_clean \
    ...
    --decodedir "exp/chain/Conformer-I/3407-${num_units}units/decode_dev_clean_bpe.5000.varikn_acwt1.0"
  local/chain/decode.sh --datadir data/dev_other/ \
    --acwt 1.0 --post-decode-acwt 10.0 \
    --hparams hyperparams/chain/Conformer-I.yaml \
    --py_script "local/chain/sb-test-conformer-mtl-avg.py" \
    --decodedir "exp/chain/Conformer-I/3407-${num_units}units/decode_dev_other_bpe.5000.varikn_acwt1.0"
fi
...
if [ $stage -le 28 ]; then
  local/chain/decode.sh --datadir data/test_clean \
    ...
    --hparams hyperparams/chain/Conformer-I.yaml \
    --py_script "local/chain/sb-test-conformer-mtl-avg.py" \
    --decodedir "exp/chain/Conformer-I/3407-${num_units}units/decode_test_clean_bpe.5000.varikn_acwt1.0"
  local/chain/decode.sh --datadir data/test_other/ \
    --acwt 1.0 --post-decode-acwt 10.0 \
    --hparams hyperparams/chain/Conformer-I.yaml \
    --py_script "local/chain/sb-test-conformer-mtl-avg.py" \
    --decodedir "exp/chain/Conformer-I/3407-${num_units}units/decode_test_other_bpe.5000.varikn_acwt1.0"
fi

# Decode the small one too
if [ $stage -le 27 ]; then
  local/chain/decode.sh --datadir data/dev_clean \
    --acwt 1.0 --post-decode-acwt 10.0 \
    --hparams hyperparams/chain/Conformer-I.yaml \
