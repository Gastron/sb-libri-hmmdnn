...
if [ $# != 3 ]; then
  echo "Usage: $0 [options] <data-dir> <lang-dir> <tree-dir>"
  echo " e.g.: $0 data/train data/lang_chain exp/chain/e2e_tree"
...
if [ $stage -le 1 ]; then
  # Alignments are not copied (alignments aren't used at all)
  # but we need to still add num_jobs_valid here as well
